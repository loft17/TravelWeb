...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insertar configuración de destination, date_start y date_finish
    $conn->query("INSERT INTO configurations (config_key, config_value) VALUES ('destination', 'Japon') ON DUPLICATE KEY UPDATE config_value = 'Mexico'");
    $conn->query("INSERT INTO configurations (config_key, config_value) VALUES ('date_start', '2025-01-01') ON DUPLICATE KEY UPDATE config_value = '2025-01-01'");
    $conn->query("INSERT INTO configurations (config_key, config_value) VALUES ('date_finish', '2025-12-31') ON DUPLICATE KEY UPDATE config_value = '2025-12-31'");
