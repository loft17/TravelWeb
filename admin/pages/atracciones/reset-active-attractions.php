...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE atracciones SET activo = 1 WHERE activo = 0 AND viaje_id = ?");
...
$stmt2 = $conn->prepare("SELECT id, nombre FROM atracciones WHERE activo = 0 AND viaje_id = ?");
